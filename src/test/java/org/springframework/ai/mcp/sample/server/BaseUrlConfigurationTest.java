...
public class BaseUrlConfigurationTest {
    ...
    public void testSystemPropertyBaseUrl() {
        ...
        System.setProperty("intacct.base.url", "https://partner.intacct.com/ia/api/v1-beta2");
    ...
    public void testPropertiesBaseUrl() {
        ...
        authConfig.setBaseUrl("https://partner.intacct.com/ia/api/v1-beta2");
    ...
    public void testPropertiesPriorityOverSystemProperty() {
        ...
        System.setProperty("intacct.base.url", "https://partner.intacct.com/ia3/api/v1-beta2");
