...
public class ModelService {
    ...
    // mvn compile exec:java -Dexec.mainClass="org.springframework.ai.mcp.sample.server.ModelService" -Dexec.classpathScope="test" -Dexec.args="accounts-payable/vendor" | cat
    // mvn compile exec:java -Dexec.mainClass="org.springframework.ai.mcp.sample.server.ModelService" -Dexec.classpathScope="test" | cat
